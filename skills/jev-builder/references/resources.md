...
Source review: September 22, 2026. These links are a starting map, not endorsements.
...
| [Swift](https://github.com/krzyzanowskim/TypeSafe), [Ruby](https://github.com/obie/ruby_decision_model), [Elixir](https://github.com/dannote/jev) | Community clients; the Ruby gem defaults to OpenRouter and the Elixir one answers into a GenServer |
...
[SemIf](https://github.com/TheoLeeCJ/SemIf), [simple-jev](https://github.com/featherless-ai/simple-jev),
...
to a commit and a decision point, [yibie/awesome-jev](https://github.com/yibie/awesome-jev) is the
broadest, and [github.com/topics/jev](https://github.com/topics/jev) is unfiltered. One author can
publish many repositories at once, so volume proves nothing.
